...
namespace runtime {
    builder::dyn_var<int(char*, int, char*, int, int*)> zlib_compress = builder::as_global("zlib_compress");
    builder::dyn_var<int(char*, int, char*, int, int*)> zlib_decompress = builder::as_global("zlib_decompress");
}
